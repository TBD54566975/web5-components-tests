...
print("\nCreate a did for the issuer: ")
resp = requests.put('http://localhost:8080/v1/dids/key', data = json.dumps({"keyType":"Ed25519"}))
print(resp.json())
...
with open("./testdata/kyc-schema-input.json","r") as file:
...
with open("./testdata/manifest-input.json","r") as file:
    jsonData = json.load(file)
